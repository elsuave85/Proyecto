...
public class Areas17 {
	...
	public static void main(String[] args) {
	  ...
	  case 2:
		...
		int base=Integer.parseInt(JOptionPane.showInputDialog("Introduce el lado del rectangulo"));
	  ...
	  case 3:
		  ...
		  altura=Integer.parseInt(JOptionPane.showInputDialog("Introduce la altura del triangulo"));
			...
			System.out.println("El resultado del area del triangulo es:" + (base*altura)/2);
			break;
	  ...
	  case 4:
		  ...
		  System.out.print("El resultado del area del circulo es ");
		  System.out.printf("%1,2f", Math.PI*(Math.pow(radio, 2))  );
		  break;
		   
		  default:
			  System.out.println("la opcion no es correcto");
